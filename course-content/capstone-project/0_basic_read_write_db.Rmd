...
# or load with maven cooridnates
conf$`sparklyr.shell.packages` <- "org.postgresql:postgresql:42.2.6"
...
```{r}
spark_write_jdbc(dummy_data_tbl, "dumm_table", mode = "Overwrite", options = list(
