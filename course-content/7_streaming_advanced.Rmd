...
`window(timestamp,  "7 days", "3 days")` defines a sliding window over the timestamp column which has a size of 7 days (any data later than the watermark (14-days) is dropped, within this time, the window is updated) and and slides over every 3 days.
...
# TODO how to add time windows into JOIN?
#expr("""
